  ...
  return (
    <section className='mb-8 mt-24 md:mt-8'>
      <div className='h-72 flex items-end justify-center px-8 md:px-0'>
        ...
        <div className="md:w-1/2 flex flex-row flex-wrap  justify-center md:justify-end items-end relative p-4 bg-red-700  bg-opacity-20 border border gray-200 rounded-lg">
